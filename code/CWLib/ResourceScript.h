...
public:
    ...
    void (*GetFn)(CScriptContext*, const void*, void*);
    void (*SetFn)(CScriptContext*, void*, const void*);
};
...
public:
    ...
    NativeFunctionWrapper BoundFunctionNative;
};
...
public:
    ...
    bool LookupFunctionHier(const CSignature&, NVirtualMachine::CScriptFunctionBinding*, NativeFunctionWrapper*) const;
    ...
    inline CParasiticVector<const Instruction> GetFunctionBytecode(const CFunctionDefinitionRow* function) const
    {
        u32 count = function->GetBytecodeSize();
        return CParasiticVector<const Instruction>(SharedBytecode.begin() + function->BytecodeBegin, count, count);
    }
...
private:
    ...
    CRawVector<Instruction> SharedBytecode;
    ...
    bool FixedUp;
    bool Finishing;
    mutable bool WantGetStaticInstance;
